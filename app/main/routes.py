""" this file will have different handler for a given URL as a view functions
...
#Both routes are associated with the only view function in the application,  how to change this?
